...
## Manually update timepoint information in the metadata

(1) Manually correct a typo:
...
```{r}
print("Before correcting the error in timepoint for CBO-MOK20004-WT-Day3:")
...
print("After correcting the error in timepoint for CBO-MOK20004-WT-Day3:")
print("Table between ko_gene and differentiated_timepoint_value:")
table(meta$ko_gene, meta$differentiated_timepoint_value)
```

(2) Manually update timepoint information for some originally day 5 samples in the metadata

According to information from JAX, part of the samples from day 5 in fact should
have a timepoint that is closer to day 6. This is the group of samples under day 5
and from run_id 
...
Since the other samples from day 5 only have one WT, in later DE analysis, ignore 
these samples and do not run DE analysis for day 5. 
...
length(index_day5_to_change)
meta[index_day5_to_change, c("run_id", "differentiated_timepoint_value")]

meta$differentiated_timepoint_value[index_day5_to_change] = 6

table(meta$run_id, meta$differentiated_timepoint_value)

print("After correcting timepoint for some samples originally labeled as day 5:")
print("Table between ko_gene and differentiated_timepoint_value:")
table(meta$ko_gene, meta$differentiated_timepoint_value)
```
