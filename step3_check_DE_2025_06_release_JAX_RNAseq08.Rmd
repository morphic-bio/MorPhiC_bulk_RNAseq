---
title: "Check the results of differential expression analysis for 2025-06 release JAX_RNAseq08"
...
gene_info[gene_info$ExM_min > 2e4, c("ExM_min", "PrS_min", "hgnc_symbol")]
gene_info[gene_info$PrS_min > 2e4, c("ExM_min", "PrS_min", "hgnc_symbol")]
...
This dataset has two model systems: ExM and PrS, and two conditions, nor and hyp. 
...
for(k in 1:nrow(df_file_info)){
  ...
  print(table(res_k$DE))
   ...
   if (gene_name %in% c('ASCL2', 'ELF5', 'HIF1A', 'TP63')){
