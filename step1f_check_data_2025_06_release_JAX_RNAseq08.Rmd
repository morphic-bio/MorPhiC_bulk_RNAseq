---
title: "Check RNAseq data of 2025-06 release JAX_RNAseq08"
...
Check the bulk RNAseq JAX_RNAseq08 data from June 2025 release.

This dataset spans

* KOLF2.2J,
* day 6,
* fibroblast of villous mesenchyme (CL:0002558) primitive syncytium,
* WT and PTC,
* 3% and 20% oxygen for some samples.
...
meta_file = paste0(metadata_path, "/JAX_RNAseq08.xlsx")
...
fwrite(meta, file = "data/June_2025/JAX_RNAseq08_meta_data.tsv", sep="\t")
```
