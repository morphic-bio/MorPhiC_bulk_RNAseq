...
ggplot(de_g1, aes(x = nDE_01, y = reorder(gene, nDE_01))) +
  geom_bar(stat = "identity", fill = "skyblue1", color = "royalblue4", 
           alpha = 0.7, width = 0.8) + 
  labs(x = "# of DE genes", y="") 
```

```{r fig.width = 6, fig.height = 3}

ggplot(de_g2, aes(x = nDE_01, y = reorder(gene, nDE_01))) +
  geom_bar(stat = "identity", fill = "skyblue1", color = "royalblue4", 
           alpha = 0.7, width = 0.8) + 
  labs(x = "# of DE genes", y="") 
