---
title: "Check the results of differential expression analysis for 2024-09 release JAX_RNAseq5_ExE_CBO"
...
This dataset has two model systems: CBO and PrS. DE analyses were run for three general (model system, day) levels : 
...
print("PrS_day_6_TWIST2 is excluded from the subfigure on the left.")
print("It has adjusted pvalue being set to NA.")
