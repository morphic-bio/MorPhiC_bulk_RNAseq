...
This dataset has two model systems: CBO and PrS. DE analyses were run for three DE groups: 

    CBO_day_9
    PrS_day_6_20231214_23-robson-016
    PrS_day_6_20231226_23-robson-018
...
Do it separately for each DE group.
...
for (d_group in sorted_de_grps){
  ...
  if (d_group=="PrS_day_6_20231214_23-robson-016"){
...
for(k in 1:nrow(df_file_info)){
  ...
  de_gene_sets[[paste0(gene_name, "_PTC_up")]] = res_k[ww_up,]$gene_ID
  de_gene_sets[[paste0(gene_name, "_PTC_down")]] = res_k[ww_down,]$gene_ID
