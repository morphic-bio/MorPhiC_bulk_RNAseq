...
This dataset has two model systems: CBO and PrS. 

There is only one knockout strategy: PTC.

DE analyses were run for two general (model system, day) levels: 
...
print("the gene OVOL1 does not show up properly in the subfigure on the left")
