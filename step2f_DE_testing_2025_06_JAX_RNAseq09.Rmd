---
title: "Differential expression analysis for 2025-06 release JAX_RNAseq09"
...
Differential expression using the bulk RNAseq JAX_RNAseq09 data from the June 2025 release.
...
path = "../../MorPhiC/data/MorPhiC_internal_releases/MorPhiC_Release_June_2025/JAX_RNAseq09/"
...
meta = fread("data/June_2025/JAX_RNAseq09_meta_data.tsv", data.table = FALSE)
dim(meta)
meta[1:2, ]
names(meta)
...
table(meta$ko_gene, meta$gene_group, meta$timepoint, meta$model_system)
```
...
```{r}
table(meta$gene_group, meta$run_id, meta$timepoint, meta$model_system)
```
...
release_name = "2025_06_JAX_RNAseq09"
...
for(model1 in unique_model_ss){
  ...
  sample_info$de_grp = paste0(sample_info$de_grp, "_", sample_info$gene_group)
