---
title: "Check RNAseq data of 2025-06 release JAX_RNAseq09"
...
Check the bulk RNAseq JAX_RNAseq09 data from the June 2025 release.

This dataset spans

* KOLF2.2J,
* days 8, 9, 11, 14,
* Cortical brain (dorsal forebrain patterning),
* WT and PTC,
* only 20% oxygen.
...
meta_file = paste0(metadata_path, "/JAX_RNAseq09.xlsx")
...
fwrite(meta, file = "data/June_2025/JAX_RNAseq09_meta_data.tsv", sep="\t")
```
