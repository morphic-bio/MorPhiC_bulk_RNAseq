---
title: "Check RNAseq data of 2024-09 release, JAX_RNAseq6_Diverse"
...
Check the bulk RNAseq JAX_RNAseq6_Diverse data from September 2024 release.
...
## Read in meta data
Use the updated version of metadata spreadsheet which corrected the inconsistency issues for two samples. 
```{r fig.width = 3, fig.height=3}
#meta_file = "../../MorPhiC/data/September-2024/JAX_RNAseq6_Diverse/metadata/STUDY6_DPC_Metadata_template_v2.xlsx"
meta_file = "../../MorPhiC/data/September-2024/JAX_RNAseq6_Diverse/metadata/STUDY6_DPC_Metadata_template_v2-rev1.xlsx"
...
fwrite(meta, file = "data/September_2024/JAX_RNAseq6_Diverse_meta_data.tsv", sep="\t")
```
...
# the difference between the filenames in metadata file and those in genescount matrix
# was resolved after switching to use the updated metadata spreadsheet
