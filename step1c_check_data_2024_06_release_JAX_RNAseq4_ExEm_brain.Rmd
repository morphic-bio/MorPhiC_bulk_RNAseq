...
based on the conjecture that in the "Differentiated cell line" tab (which has been merged into meta data frame), the item in the first row of column "cell_line.biomaterial_core.biomaterial_id", being "MOK20013W-D02", should actually be "MOK20001P-B11" 
